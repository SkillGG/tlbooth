    ...
    if (typeof node === "object" && "props" in node) {
      ...
      if (
        ...
        if (Array.isArray(props.children)) {
          const ret = props.children.map((c) =>
            deepReplace(c as ReactNode, r),
          );
